package ude.kh.poly.ex1.model.service;

import ude.kh.poly.ex1.model.vo.Car;
import ude.kh.poly.ex1.model.vo.Spark;
import ude.kh.poly.ex1.model.vo.Tesla;
...
public class PolyService {
	...
	public void ex1() {
		...
		car3.setFuel("휘발류");
		car3.setWheel(4);
		// car2.setDiscountOffer(0.5);
		
		//------------------------------------------------------------
		
		
		// 2) 다형성을 이용한 객체 배열
		// 객채 배열 : 같은 객체 참조 자료형의 변수를 하나의 묶음으로 다루는 것
		...
		for(int i = 0; i < arr.length; i++) {
			System.err.println(i + "번째 인덱스의 엔진" + arr[i].getEngine());
		}
	...
	public void ex2() {
		...
		Spark s = new Spark("겅차 엔진", "휘발유", 4, 0.5);
	...
	// 전달 받은 Car 또는 자식객체의 엔진, 연료, 바퀴개수를 출력하는 메서드
	// 매개변수 부모타입 참조변수를 작성하면 모든 자식 객체를 전달 받을 수 있다.
